...
DEVICE_PACKAGE_OVERLAYS += device/telechips/m805_880x/overlay

PRODUCT_AAPT_CONFIG := hdpi mdpi ldpi
...
PRODUCT_COPY_FILES := \
	$(LOCAL_KERNEL):kernel \
	device/telechips/m805_880x/init.m805_880x.rc:root/init.m801_88.rc \
	device/telechips/m805_880x/init.m805_880x.usb.rc:root/init.m801_88.usb.rc\
	device/telechips/m805_880x/init.m805_880x.wifi.rc:root/init.m801_88.wifi.rc
...
PRODUCT_COPY_FILES += \
	device/telechips/m805_880x/tcc-ts.idc:system/usr/idc/tcc-ts.idc

PRODUCT_COPY_FILES += \
	device/telechips/m805_880x/tcc-ts-sitronix.idc:system/usr/idc/tcc-ts-sitronix.idc

PRODUCT_COPY_FILES += \
	device/telechips/m805_880x/tcc-ts-goodix-cap.idc:system/usr/idc/tcc-ts-goodix-cap.idc
