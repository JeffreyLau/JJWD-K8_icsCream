...
PRODUCT_COPY_FILES := \
	...
	device/telechips/m805_892x/init.m805_892x.wifi.rc:root/init.m805_892x.wifi.rc
...
# full apk
PRODUCT_PACKAGES += FileExplorer.apk

# jeffrey 20130612 
PRODUCT_COPY_FILES += \
	device/telechips/m805_892x/applib/libdriverecord.so:system/lib/libdriverecord.so \
	device/telechips/m805_892x/applib/libFmNative.so:system/lib/libFmNative.so

# jeffrey for App 20130612
PRODUCT_PACKAGES += \
	AsternCamera 
#	DriveRecord \
#	FmRadio \
...
PRODUCT_COPY_FILES += \
	device/telechips/m805_892x/tcc-ts-goodix-cap.idc:system/usr/idc/ft5x0x_ts.idc

PRODUCT_COPY_FILES += \
	device/telechips/m805_892x/tcc_gps/gps.conf:system/etc/gps.conf 
#	device/telechips/m805_892x/tcc_gps/gps.tcc892x.so:system/lib/hw/gps.tcc892x.so
#	device/telechips/m805_892x/gps.tcc892x.so:system/lib/hw/gps.tcc892x.so
...
PRODUCT_COPY_FILES += \
	device/telechips/common/initlogo480x800.rle:root/initlogo.rle
...
# add by jeffrey 20130624
#ifeq ($(BOARD_GPS_MAKER),tcc_gps)
PRODUCT_COPY_FILES += \
	device/telechips/m805_892x/tcc_gps/cgvuart.ko:root/lib/modules/cgvuart.ko \
	device/telechips/m805_892x/tcc_gps/cgxdrv.ko:system/TccGps/cgxdrv.ko \
	device/telechips/m805_892x/tcc_gps/tcc_gps:system/TccGps/tcc_gps \
	device/telechips/m805_892x/tcc_gps/rungps.sh:system/TccGps/rungps.sh \
	device/telechips/m805_892x/tcc_gps/HiMap.db:system/TccGps/HiMap.db \
	device/telechips/m805_892x/tcc_gps/Almanac.cg:system/TccGps/Almanac.cg \
	device/telechips/m805_892x/tcc_gps/Hca.cg:system/TccGps/Hca.cg \
	device/telechips/m805_892x/tcc_gps/Ionosphere.cg:system/TccGps/Ionosphere.cg
#endif
