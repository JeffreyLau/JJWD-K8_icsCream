...
TARGET_BOOTLOADER_BOARD_NAME := tcc8800_evm
else
TARGET_BOOTLOADER_BOARD_NAME := tcc8800_evm_emmc
endif
TARGET_NO_BOOTLOADER := true
TARGET_NO_RADIOIMAGE := true

KERNEL_DEFCONFIG := tcc880x_defconfig
...
TARGET_RECOVERY_UI_LIB := librecovery_ui_tcc8800
TARGET_RECOVERY_UPDATER_LIBS += librecovery_updater_telechips
TARGET_RECOVERY_INIT_RC := device/telechips/tcc8800/recovery/init.tcc8800.rc
