...
TARGET_BOOTLOADER_BOARD_NAME := tcc8920_evm
else
TARGET_BOOTLOADER_BOARD_NAME := tcc8920_evm_emmc
endif
...
TARGET_RECOVERY_INIT_RC := device/telechips/tcc8920/recovery/init.tcc8920.rc
