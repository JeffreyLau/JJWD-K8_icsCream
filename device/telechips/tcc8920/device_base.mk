...
DEVICE_PACKAGE_OVERLAYS += device/telechips/tcc8920/overlay
...
PRODUCT_COPY_FILES := \
	$(LOCAL_KERNEL):kernel \
	device/telechips/tcc8920/init.tcc8920.rc:root/init.tcc8920.rc \
	device/telechips/tcc8920/init.tcc8920.usb.rc:root/init.tcc8920.usb.rc \
	device/telechips/tcc8920/init.tcc8920.wifi.rc:root/init.tcc8920.wifi.rc

# Define TCC video vsync mode
PRODUCT_PROPERTY_OVERRIDES += \
	tcc.video.vsync.support = 1 \
	tcc.video.vsync.threshold = 1 \
...
PRODUCT_COPY_FILES += \
	device/telechips/tcc8920/tcc-ts.idc:system/usr/idc/tcc-ts.idc

PRODUCT_COPY_FILES += \
	device/telechips/tcc8920/tcc-ts-sitronix.idc:system/usr/idc/tcc-ts-sitronix.idc

PRODUCT_COPY_FILES += \
	device/telechips/tcc8920/tcc-ts-goodix-cap.idc:system/usr/idc/tcc-ts-goodix-cap.idc
