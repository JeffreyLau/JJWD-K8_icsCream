...
void Register_librecovery_updater_telechips() {
    fprintf(stderr, "installing telechips updater extensions\n");

    RegisterFunction("telechips.install_bootloader", UpdateFn);
}
