...
#define CPU_SRC_PLL DIRECTPLL0	// cpu
#define CPU_PLL_ADDR 0x000030
#define MEM_SRC_PLL DIRECTPLL1	// mem
#define MEM_PLL_ADDR 0x000034
#else
#define CPU_SRC_PLL DIRECTPLL5	// cpu
#define CPU_PLL_ADDR 0x000044
#define MEM_SRC_PLL DIRECTPLL4	// mem
...
//	*(volatile unsigned long *)addr_iocfg(0x18) &= ~Hw29;		// I2C_0 S/W RESET
	...
	*(volatile unsigned long *)addr_iocfg(0x18) |= Hw29;		// I2C_0 S/W RESET
	...
	if (PMIC_PARAM(DEV_CH) == 0) {
		...
		if (PMIC_PARAM(SYSTEM_REV) == 0x2002 || PMIC_PARAM(SYSTEM_REV) == 0x2003 || PMIC_PARAM(SYSTEM_REV) == 0x2004 || PMIC_PARAM(SYSTEM_REV) == 0x2005 || PMIC_PARAM(SYSTEM_REV) == 0x2006 || PMIC_PARAM(SYSTEM_REV) == 0x2007 || PMIC_PARAM(SYSTEM_REV) == 0x2008) {
			//I2C[12] - GPIOC[2][3]
...
#if defined(TCC_PM_MEMQ_PWR_CTRL)
	#if defined(CONFIG_MACH_M805_892X)
	if(*(volatile unsigned long *)SRAM_STACK_ADDR == 0x2000 || *(volatile unsigned long *)SRAM_STACK_ADDR == 0x2001)
...
//Bruce, wake-up source should be surely set here !!!!
	...
	{
		if(*(volatile unsigned long *)SRAM_STACK_ADDR == 0x2006 || *(volatile unsigned long *)SRAM_STACK_ADDR == 0x2007 || *(volatile unsigned long *)SRAM_STACK_ADDR == 0x2008){
		//set wake-up polarity
