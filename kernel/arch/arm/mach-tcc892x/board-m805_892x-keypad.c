...
static const struct gpio_event_direct_entry m805_892x_gpio_keymap[] = {
	...
	{ TCC_GPE(23),	KEY_HOMEPAGE },   // home		// not used system_rev 0x2008
	{ TCC_GPE(19),	KEY_MENU },       // menu		// not used system_rev 0x2003 0x2004 0x2005 0x2006 0x2007 0x2008
	{ TCC_GPE(20),	KEY_BACK },       // back		// not used system_rev 0x2003 0x2004 0x2005 0x2006 0x2007 0x2008
#else
...
static int __init m805_892x_keypad_init(void)
{
	...
	if (system_rev == 0x2003 || system_rev == 0x2004 || system_rev == 0x2005 || system_rev == 0x2006 || system_rev == 0x2007) {
		m805_892x_gpio_key_input_info.keymap_size = ARRAY_SIZE(m805_892x_gpio_keymap) - 2;
	}
	else if (system_rev == 0x2008) {
		m805_892x_gpio_key_input_info.keymap_size = ARRAY_SIZE(m805_892x_gpio_keymap) - 3;
	}
