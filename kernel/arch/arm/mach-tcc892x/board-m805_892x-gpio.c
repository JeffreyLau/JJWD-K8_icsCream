...
void __init m805_892x_init_gpio(void)
{
	if (!machine_is_m805_892x())
		return;
	tcc_gpio_config(TCC_GPD(11), GPIO_FN(0) | GPIO_OUTPUT | GPIO_HIGH);
	tcc_gpio_config(TCC_GPG(14), GPIO_FN(0) | GPIO_INPUT);
	tcc_gpio_config(TCC_GPC(8), GPIO_FN(0) | GPIO_INPUT);
