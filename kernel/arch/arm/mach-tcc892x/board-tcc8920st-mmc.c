...
#define TFCD_SDMMC_PORT		3
#define TFCD_PERI_SDMMC		PERI_SDMMC3
#define TFCD_RB_SDMMC		RB_SDMMC3CONTROLLER
#define TFCD_HwINT1_SD		HwINT1_SD3
...
int tcc8920_mmc_init(struct device *dev, int id)
{
	...
	#if defined(CONFIG_HDMI_DONGLE_WIFI_BROADCOM)
	if(id == TCC_MMC_TYPE_WIFI)
	{
