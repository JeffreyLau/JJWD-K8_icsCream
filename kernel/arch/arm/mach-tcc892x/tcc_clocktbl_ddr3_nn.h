...
//	{ 989600, 441450, 600000, 523510, 277320, 391930, 391930, 277320, 353720 }, // Core 1.42V
	...
	#if defined(CONFIG_HDB892X_CLOCK_HIGH_SPEED) || defined(CONFIG_STB_BOARD_UPC) || defined(CONFIG_HDMI_DONGLE_Single_Layer)
	{ 937500,      0, 600000,      0, 243040,      0,      0, 100000,      0 }, // Core 1.40V
	#endif
	#if !defined(CONFIG_STB_BOARD_HDB892S) && !defined(CONFIG_STB_BOARD_HDB892F) && !defined(CONFIG_HDMI_DONGLE_Double_Layer) && !defined(CONFIG_STB_BOARD_ISDBT_MODULE)
...
const struct tcc_freq_table_t gtVpuNormalClockLimitTable[] =
{
	...
	#if defined(CONFIG_HDMI_DONGLE_Double_Layer)
...
const struct tcc_freq_table_t gtVpu_720p_ClockLimitTable[] =
{
	...
	{ 625000,      0,      0,      0, 196000, 237425, 237425,      0,      0 }, //  30Mbps ~,  Core 1.30V
	#else
...
#else
	#if defined(CONFIG_HDMI_DONGLE_Double_Layer)
	{ 625000,      0,      0, 370000,      0,      0,      0,      0,      0 }, // * ~ 10Mbps, Core 1.20V
	{ 625000,      0,      0, 370000,      0,      0,      0,      0,      0 }, // * 10~20Mbps, Core 1.30V
	{ 625000,      0,      0, 370000,      0,      0,      0,      0,      0 }, //   20~30Mbps, Core 1.30V
	{ 625000,      0,      0, 370000,      0,      0,      0,      0,      0 }, //   30Mbps ~,  Core 1.30V
	#else
...
const struct tcc_freq_table_t gtHdmiClockLimitTable = {
	...
	#elif defined(CONFIG_HDMI_DONGLE_Single_Layer)
...
const struct tcc_freq_table_t gtVoipClockLimitTable[] = {
	{ 625000,      0, 533000,      0, 196000,      0,      0, 100000,      0 },	// Core 1.20V
	#if defined(CONFIG_HDMI_DONGLE_Double_Layer)
	{ 625000,      0, 533000,      0, 196000,      0,      0, 100000,      0 },	// Core 1.30V
	#else
	{ 808000,      0, 600000,      0, 243040,      0,      0, 100000,      0 },	// Core 1.30V
	#endif
};
