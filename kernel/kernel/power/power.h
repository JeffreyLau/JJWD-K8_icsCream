...
extern int hib_bio_read_page(pgoff_t page_off, void *addr,
		...
		struct bio **bio_chain);//B090162
#else
		int sync);
#endif
extern int hib_bio_read_multi_pages(pgoff_t page_off, void *addr,
#ifndef CONFIG_HIBERNATION
...
extern void swsusp_show_speed1(s64 elapsed_centisecs64,
			unsigned nr_pages, char *);
