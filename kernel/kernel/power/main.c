...
unsigned int do_hibernation = 0;
EXPORT_SYMBOL(do_hibernation);
unsigned int do_hibernation_codec = 0;
EXPORT_SYMBOL(do_hibernation_codec);
...
extern void tcc_sensor_early_suspend(void);
extern void tcc_sensor_late_resume(void);
#endif
