...
public:
    ...
    virtual int mountVol();
    virtual int unmountVol(bool force, bool revert);
    int formatVol(const char* fstype);
...
private:
    ...
    int mountPartition(char *devicePath, char*mountPoint, int gid);
};
