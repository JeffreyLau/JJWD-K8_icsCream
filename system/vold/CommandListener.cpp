...
int CommandListener::VolumeCmd::runCommand(SocketClient *cli,
    ...
    if (!strcmp(argv[1], "list")) {
        //SLOGD("==========================================");
        //SLOGD("VolumeCmd::argv: list");	
        //SLOGD("==========================================");				
        return vm->listVolumes(cli);
    } else if (!strcmp(argv[1], "debug")) {
        //SLOGD("==========================================");
        //SLOGD("VolumeCmd::argv: debug");	
        //SLOGD("==========================================");    	    
        ...
        //SLOGD("==========================================");
        //SLOGD("VolumeCmd::argv: format , :%d ", argc);	
        //SLOGD("==========================================");    		    
        if (argc < 3 || argc > 4) {
            cli->sendMsg(ResponseCode::CommandSyntaxError, "Usage: volume format <path> [vfat|ntfs]", false);
            return 0;
        }
        if (argc == 3) {
            rc = vm->formatVolume(argv[2], "vfat");
        } else {
            rc = vm->formatVolume(argv[2], argv[3]);
        }
    } else if (!strcmp(argv[1], "share")) {
        //SLOGD("==========================================");
        //SLOGD("VolumeCmd::argv: share");	
        //SLOGD("==========================================");    		    
        if (argc != 4) {
        ...
        //SLOGD("==========================================");
        //SLOGD("VolumeCmd::argv: shared (%s)", argv[2]);	
        //SLOGD("==========================================");    		    
        bool enabled = false;
        if (argc != 4) {
            cli->sendMsg(ResponseCode::CommandSyntaxError,
