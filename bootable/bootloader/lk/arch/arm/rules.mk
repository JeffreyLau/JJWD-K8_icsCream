...
OBJS += $(LOCAL_DIR)/cache-l2x0.o
endif

# set the default toolchain to arm eabi and set a #define
#TOOLCHAIN_PREFIX ?= arm-none-eabi-
TOOLCHAIN_PREFIX ?= ../../../prebuilt/$(HOST_OS)-x86/toolchain/arm-eabi-4.3.1/bin/arm-eabi-
ifneq ($(findstring eabi-,$(TOOLCHAIN_PREFIX)),)
...
CFLAGS := $(subst cortex-a5,cortex-a8,arm1136jf-s,$(CFLAGS))
endif
