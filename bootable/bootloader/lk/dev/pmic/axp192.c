...
void axp192_init(int i2c_ch)
{
	signed long data[2];
	axp192_i2c_ch = i2c_ch;
...
int axp192_set_voltage(axp192_src_id id, unsigned int mV)
{
...
int axp192_set_power(axp192_src_id id, unsigned int onoff)
{
	if (axp192_initialized == 0)
		return -1;
