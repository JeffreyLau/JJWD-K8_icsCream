...
#elif defined (CONFIG_ARCH_TCC93XX)
#define DDICFG_REG(x)				(0xB0A51000 + (x))
#elif defined(CONFIG_ARCH_TCC892X )
...
#elif defined (CONFIG_ARCH_TCC93XX)
#define HDMIDP_HDMI_SSREG(x)        (0xB0A54000 + (x))
#elif defined(CONFIG_ARCH_TCC892X)
...
#elif defined (CONFIG_ARCH_TCC93XX)
#define HDMIDP_HDMIREG(x)           	(0xB0A55000 + (x))
#elif defined(CONFIG_ARCH_TCC892X)
...
#elif defined (CONFIG_ARCH_TCC93XX)
#define HDMIDP_AESREG(x)            (0xB0A56000 + (x))
#elif defined(CONFIG_ARCH_TCC892X)
...
#elif defined (CONFIG_ARCH_TCC93XX)
#define HDMIDP_I2SREG(x)            (0xB0A58000 + (x))
#elif defined(CONFIG_ARCH_TCC892X)
...
#elif defined (CONFIG_ARCH_TCC93XX)
#define HDMIDP_SPDIFREG(x)          (0xB0A57000 + (x))
#elif defined(CONFIG_ARCH_TCC892X)
