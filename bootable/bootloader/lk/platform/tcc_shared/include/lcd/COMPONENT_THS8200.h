...
#define COMPONENT_1280_720

#define COMPONENT_WIDTH_MAX			1280
#define COMPONENT_HEIGHT_MAX		720
...
#endif	/* #if defined(DEFAULT_DISPLAY_COMPONENT) || defined(DEFAULT_DISPLAY_OUTPUT_DUAL) */
