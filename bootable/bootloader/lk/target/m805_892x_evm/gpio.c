...
struct gpio_cfg TCC8923_GPA_init_tbl[] = {
...
struct gpio_cfg TCC8923_GPB_init_tbl[] = {
	...
	{ TCC_GPB(28) ,GPIO_FN0 , GPIO_INPUT           , GPIO_PULLDISABLE }, //IRQ_RESET
#else
...
struct gpio_cfg TCC8923_GPC_init_tbl[] = {
...
#if (HW_REV == 0x2002)
	{ TCC_GPC(13) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, //PMU_HOLD
	{ TCC_GPC(14) ,GPIO_FN0 , GPIO_INPUT           , GPIO_PULLDISABLE }, //PMU_ONO
#elif (HW_REV == 0x2003) || (HW_REV == 0x2004) || (HW_REV == 0x2005)
	{ TCC_GPC(13) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, //PMU_HOLD
	{ TCC_GPC(14) ,GPIO_FN0 , GPIO_INPUT           , GPIO_PULLDISABLE }, //PMU_BATDET
#else
...
#if (HW_REV == 0x2002 || HW_REV == 0x2001) || (HW_REV == 0x2003) || (HW_REV == 0x2004) || (HW_REV == 0x2005)
...
struct gpio_cfg TCC8923_GPD_init_tbl[] = {
...
#if (HW_REV == 0x2002) || (HW_REV == 0x2003) || (HW_REV == 0x2004) || (HW_REV == 0x2005)
	{ TCC_GPD(6)  ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, //PWRMEM_CTL
#else
...
#else
	{ TCC_GPD(9)  ,GPIO_FN0 , GPIO_INPUT           , GPIO_PULLDISABLE }, //PMU_IRQ
	{ TCC_GPD(10) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
#endif
...
#else
	{ TCC_GPD(15) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, //MEMQZQ_ON
#endif
...
struct gpio_cfg TCC8923_GPE_init_tbl[] = {
#if (HW_REV == 0x2000 || HW_REV == 0x2001) 
	{ TCC_GPE(0)  ,GPIO_FN0 , GPIO_INPUT           , GPIO_PULLDISABLE }, //RTC_INT
#else
...
#else
	{ TCC_GPE(1)  ,GPIO_FN0 , GPIO_INPUT           , GPIO_PULLDISABLE }, //IRQ_RESET
#endif
	{ TCC_GPE(2)  ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
#if (HW_REV == 0x2002) || (HW_REV == 0x2003) || (HW_REV == 0x2004) || (HW_REV == 0x2005)
	{ TCC_GPE(3)  ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
#else
	{ TCC_GPE(3)  ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, //WIFI_PWREN
#endif
...
#else
	{ TCC_GPE(7)  ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, //PWR_SHDN
#endif
...
#if (HW_REV == 0x2002) || (HW_REV == 0x2003) || (HW_REV == 0x2004) || (HW_REV == 0x2005)
	{ TCC_GPE(15) ,GPIO_FN0 , GPIO_INPUT           , GPIO_PULLUP      }, //PMU_ONO
#else
...
#if (HW_REV == 0x2002) || (HW_REV == 0x2003) || (HW_REV == 0x2004) || (HW_REV == 0x2005)
	{ TCC_GPE(27) ,GPIO_FN0 , GPIO_INPUT           , GPIO_PULLDISABLE }, //PMU_IRQ
#else
...
struct gpio_cfg TCC8923_GPF_init_tbl[] = {
...
struct gpio_cfg TCC8923_GPG_init_tbl[] = {
...
#if (HW_REV == 0x2002)
	{ TCC_GPG(5)  ,GPIO_FN0 , GPIO_INPUT,            GPIO_PULLDISABLE }, //PMU_BATDET
#else
...
struct gpio_cfg TCC8923_GPHDMI_init_tbl[] = {
...
struct gpio_cfg TCC8923_GPADC_init_tbl[] = {
...
void gpio_init_early(void)
{
	...
	for(i=0 ; i<(sizeof(TCC8923_GPA_init_tbl)/sizeof(TCC8923_GPA_init_tbl[0])) ; i++)
		gpio_config(TCC8923_GPA_init_tbl[i].port, TCC8923_GPA_init_tbl[i].function|TCC8923_GPA_init_tbl[i].direction|TCC8923_GPA_init_tbl[i].pull);

	for(i=0 ; i<(sizeof(TCC8923_GPB_init_tbl)/sizeof(TCC8923_GPB_init_tbl[0])) ; i++)
		gpio_config(TCC8923_GPB_init_tbl[i].port, TCC8923_GPB_init_tbl[i].function|TCC8923_GPB_init_tbl[i].direction|TCC8923_GPB_init_tbl[i].pull);

	for(i=0 ; i<(sizeof(TCC8923_GPC_init_tbl)/sizeof(TCC8923_GPC_init_tbl[0])) ; i++)
		gpio_config(TCC8923_GPC_init_tbl[i].port, TCC8923_GPC_init_tbl[i].function|TCC8923_GPC_init_tbl[i].direction|TCC8923_GPC_init_tbl[i].pull);

	for(i=0 ; i<(sizeof(TCC8923_GPD_init_tbl)/sizeof(TCC8923_GPD_init_tbl[0])) ; i++)
		gpio_config(TCC8923_GPD_init_tbl[i].port, TCC8923_GPD_init_tbl[i].function|TCC8923_GPD_init_tbl[i].direction|TCC8923_GPD_init_tbl[i].pull);

	for(i=0 ; i<(sizeof(TCC8923_GPE_init_tbl)/sizeof(TCC8923_GPE_init_tbl[0])) ; i++)
		gpio_config(TCC8923_GPE_init_tbl[i].port, TCC8923_GPE_init_tbl[i].function|TCC8923_GPE_init_tbl[i].direction|TCC8923_GPE_init_tbl[i].pull);

	for(i=0 ; i<(sizeof(TCC8923_GPF_init_tbl)/sizeof(TCC8923_GPF_init_tbl[0])) ; i++)
		gpio_config(TCC8923_GPF_init_tbl[i].port, TCC8923_GPF_init_tbl[i].function|TCC8923_GPF_init_tbl[i].direction|TCC8923_GPF_init_tbl[i].pull);

	for(i=0 ; i<(sizeof(TCC8923_GPG_init_tbl)/sizeof(TCC8923_GPG_init_tbl[0])) ; i++)
		gpio_config(TCC8923_GPG_init_tbl[i].port, TCC8923_GPG_init_tbl[i].function|TCC8923_GPG_init_tbl[i].direction|TCC8923_GPG_init_tbl[i].pull);

	for(i=0 ; i<(sizeof(TCC8923_GPHDMI_init_tbl)/sizeof(TCC8923_GPHDMI_init_tbl[0])) ; i++)
		gpio_config(TCC8923_GPHDMI_init_tbl[i].port, TCC8923_GPHDMI_init_tbl[i].function|TCC8923_GPHDMI_init_tbl[i].direction|TCC8923_GPHDMI_init_tbl[i].pull);

	for(i=0 ; i<(sizeof(TCC8923_GPADC_init_tbl)/sizeof(TCC8923_GPADC_init_tbl[0])) ; i++)
		gpio_config(TCC8923_GPADC_init_tbl[i].port, TCC8923_GPADC_init_tbl[i].function|TCC8923_GPADC_init_tbl[i].direction|TCC8923_GPADC_init_tbl[i].pull);
