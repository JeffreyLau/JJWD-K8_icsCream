...
#ifdef USE_VIQE
#define PMEM_VIQE_SIZE			(16*SZ_1M)
#else
...
#define TOTAL_FIXED_MEM_SIZE		(PMEM_SURF_SIZE + PMEM_VIQE_SIZE+ UMP_RESERVED_SIZE + EXT_CAM_SIZE  + FB_MEM_SIZE + OVERLAY_MEM_TOTAL_SIZE + VIDEO_MEM_TOTAL_SIZE + FB_SCALE_MEM_TOTAL_SIZE + VIDEO_DUAL_DISPLAY_SIZE)
