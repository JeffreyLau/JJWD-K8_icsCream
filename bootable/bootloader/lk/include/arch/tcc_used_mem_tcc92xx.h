...
#else
#define OVERLAY_MEM_TOTAL_SIZE		(6*SZ_1M)
#endif
#define VIDEO_MEM_TOTAL_SIZE		(36*SZ_1M)

#define FB_SCALE_MEM_TOTAL_SIZE		(6*SZ_1M)
...
#define TOTAL_FIXED_MEM_SIZE		(PMEM_SURF_SIZE+PMEM_VIQE_SIZE+PMEM_CAM_SIZE+OVERLAY_MEM_TOTAL_SIZE+VIDEO_MEM_TOTAL_SIZE+FB_SCALE_MEM_TOTAL_SIZE + CC_UI_MEM_TOTAL_SIZE)
