...
#if defined(DISPLAY_STB_DUAL) || defined(DISPLAY_STB_AUTO_DETECT) || defined(DISPLAY_STB_ATTACH_DUAL) || defined(DISPLAY_STB_ATTACH_DUAL_AUTO)
...
#define OUTPUT_ATTACH_MEM_SIZE		(ARRAY_MBYTE(HDMI_DISPLAY_MAX_WIDTH * HDMI_DISPLAY_MAX_HEIGHT * 4 * 2))
#else
#define OUTPUT_ATTACH_MEM_SIZE		(0)
#endif

#define TOTAL_FIXED_MEM_SIZE		(PMEM_SURF_SIZE + PMEM_VIQE_SIZE + UMP_RESERVED_SIZE + EXT_CAM_SIZE + FB_MEM_SIZE + OVERLAY_MEM_TOTAL_SIZE + VIDEO_MEM_TOTAL_SIZE + FB_SCALE_MEM_TOTAL_SIZE + VIDEO_DUAL_DISPLAY_SIZE + OUTPUT_ATTACH_MEM_SIZE)
...
#define OUTPUT_ATTACH_MEM_BASE		(VIDEO_DUAL_DISPLAY_BASE + VIDEO_DUAL_DISPLAY_SIZE)
